...
class VoyagerDepartmentController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($user->role_id != '1') {
            return redirect('/')->with('error', 'You need to be an Administrator in order to access that section.');
        }
    ...
    public function show(Request $request, $id)
    {
        ...
        $userAccess =  DB::table('user_department')->where([['user_id', $user->id],['department_id', $id]])->first();
